...
public class MensagensPadrao {
    ...
    public static final String OBS_FISCALIZACAO = "Observação da Fiscalização";
    ...
    public static final String QUESTIONARIO_QUALIDADE_COMUNICACAO_ATENDENTE_NAO_ESCUTA = " Atendente Não Escuta";
